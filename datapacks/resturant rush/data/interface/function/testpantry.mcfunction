...
execute as @e[tag=pantry_i1] at @s if data entity @s interaction on target run give @s baked_potato[item_name={"color":"gold","text":"Stuffed Potato"}]
...
execute as @e[tag=pantry_i2] at @s if data entity @s interaction on target run give @s bread[item_name={"color":"gold","text":"Garlic Bread"}]
...
execute as @e[tag=pantry_i3] at @s if data entity @s interaction on target run give @s mushroom_stew[item_name={"color":"gold","text":"Mushroom Soup"}]
...
execute as @e[tag=pantry_i4] at @s if data entity @s interaction on target run give @s apple[item_name={"color":"red","text":"Shiny Apple"}]
...
execute as @e[tag=pantry_i5] at @s if data entity @s interaction on target run give @s cookie[item_name={"color":"gold","text":"Chocolate Cookie"}]
...
execute as @e[tag=pantry_i6] at @s if data entity @s interaction on target run give @s carrot[item_name={"color":"gold","text":"Raw Carrot"}]
...
execute as @e[tag=pantry_i1] at @s if data entity @s attack on attacker run give @s baked_potato[item_name={"color":"gold","text":"Stuffed Potato"}]
...
execute as @e[tag=pantry_i2] at @s if data entity @s attack on attacker run give @s bread[item_name={"color":"gold","text":"Garlic Bread"}]
...
execute as @e[tag=pantry_i3] at @s if data entity @s attack on attacker run give @s mushroom_stew[item_name={"color":"gold","text":"Mushroom Soup"}]
...
execute as @e[tag=pantry_i4] at @s if data entity @s attack on attacker run give @s apple[item_name={"color":"red","text":"Shiny Apple"}]
...
execute as @e[tag=pantry_i5] at @s if data entity @s attack on attacker run give @s cookie[item_name={"color":"gold","text":"Chocolate Cookie"}]
...
execute as @e[tag=pantry_i6] at @s if data entity @s attack on attacker run give @s carrot[item_name={"color":"gold","text":"Raw Carrot"}]
